...
\item 
\mbox{\hyperlink{classDecoder_acb1932b930cb29f58696065d19e5477f}{Decoder}} ()=default
\item 
\mbox{\hyperlink{classDecoder_afcf53f028a091b22c504656cb091da83}{Decoder}} (const AVCodec\+Parameters $\ast$params)
\item 
\mbox{\hyperlink{classDecoder_ab3219e91712f38ed4e4cd1a81f033b83}{Decoder}} (const \mbox{\hyperlink{classDecoder}{Decoder}} \&)=delete
\item 
\mbox{\hyperlink{classDecoder_a3034611a5e49fe7738d686a324a12add}{Decoder}} (\mbox{\hyperlink{classDecoder}{Decoder}} \&\&other) noexcept
\item 
\mbox{\hyperlink{classDecoder_aa8569c2bfe52745017f0260ee0a3c424}{$\sim$\+Decoder}} ()=default
\item 
...
\item 
\mbox{\hyperlink{namespaceav_abcf8febb01b83a6bf7671fc1793f23f0}{av\+::\+Frame\+UPtr}} \mbox{\hyperlink{classDecoder_a14d4f27737b208d96bdfcadf9f7068c4}{get\+Frame}} ()
\item 
...
\mbox{\Hypertarget{classDecoder_acb1932b930cb29f58696065d19e5477f}\label{classDecoder_acb1932b930cb29f58696065d19e5477f}} 
\index{Decoder@{Decoder}!Decoder@{Decoder}}
\index{Decoder@{Decoder}!Decoder@{Decoder}}
\doxysubsubsection{\texorpdfstring{Decoder()}{Decoder()}\hspace{0.1cm}{\footnotesize\ttfamily [1/4]}}
{\footnotesize\ttfamily Decoder\+::\+Decoder (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [default]}}

\mbox{\Hypertarget{classDecoder_afcf53f028a091b22c504656cb091da83}\label{classDecoder_afcf53f028a091b22c504656cb091da83}} 
\index{Decoder@{Decoder}!Decoder@{Decoder}}
\index{Decoder@{Decoder}!Decoder@{Decoder}}
\doxysubsubsection{\texorpdfstring{Decoder()}{Decoder()}\hspace{0.1cm}{\footnotesize\ttfamily [2/4]}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{00013                                                 \{}
\DoxyCodeLine{00014     \textcolor{keywordflow}{if} (!params) throwRuntimeError(\textcolor{stringliteral}{"{}received stream parameters ptr is null"{}});}
\DoxyCodeLine{00015 }
\DoxyCodeLine{00016     codec\_ = avcodec\_find\_decoder(params-\/>codec\_id);}
\DoxyCodeLine{00017     \textcolor{keywordflow}{if} (!codec\_) throwRuntimeError(\textcolor{stringliteral}{"{}cannot find codec"{}});}
\DoxyCodeLine{00018 }
\DoxyCodeLine{00019     codec\_ctx\_ = \mbox{\hyperlink{namespaceav_a626540c7621a1e06ba5b9d2206006904}{av::CodecContextUPtr}}(avcodec\_alloc\_context3(codec\_));}
\DoxyCodeLine{00020     \textcolor{keywordflow}{if} (!codec\_ctx\_) throwRuntimeError(\textcolor{stringliteral}{"{}failed to allocated memory for AVCodecContext"{}});}
\DoxyCodeLine{00021 }
\DoxyCodeLine{00022     \textcolor{keywordflow}{if} (avcodec\_parameters\_to\_context(codec\_ctx\_.get(), params) < 0)}
\DoxyCodeLine{00023         throwRuntimeError(\textcolor{stringliteral}{"{}failed to copy codec params to codec context"{}});}
\DoxyCodeLine{00024 }
\DoxyCodeLine{00025     \textcolor{keywordflow}{if} (avcodec\_open2(codec\_ctx\_.get(), codec\_, \textcolor{keyword}{nullptr}) < 0) throwRuntimeError(\textcolor{stringliteral}{"{}unable to open the av codec"{}});}
\DoxyCodeLine{00026 \}}
...
\index{Decoder@{Decoder}!Decoder@{Decoder}}
\index{Decoder@{Decoder}!Decoder@{Decoder}}
\doxysubsubsection{\texorpdfstring{Decoder()}{Decoder()}\hspace{0.1cm}{\footnotesize\ttfamily [3/4]}}
{\footnotesize\ttfamily Decoder\+::\+Decoder (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classDecoder}{Decoder}} \&}]{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [delete]}}

\mbox{\Hypertarget{classDecoder_a3034611a5e49fe7738d686a324a12add}\label{classDecoder_a3034611a5e49fe7738d686a324a12add}} 
\index{Decoder@{Decoder}!Decoder@{Decoder}}
\index{Decoder@{Decoder}!Decoder@{Decoder}}
\doxysubsubsection{\texorpdfstring{Decoder()}{Decoder()}\hspace{0.1cm}{\footnotesize\ttfamily [4/4]}}
{\footnotesize\ttfamily Decoder\+::\+Decoder (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classDecoder}{Decoder}} \&\&}]{other }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [noexcept]}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{00028 : \mbox{\hyperlink{classDecoder_acb1932b930cb29f58696065d19e5477f}{Decoder}}() \{ \mbox{\hyperlink{classDecoder_a3afcf16131999c2fdeddb7d1d483a69d}{swap}}(*\textcolor{keyword}{this}, other); \}}

\end{DoxyCode}
\mbox{\Hypertarget{classDecoder_aa8569c2bfe52745017f0260ee0a3c424}\label{classDecoder_aa8569c2bfe52745017f0260ee0a3c424}} 
...
{\footnotesize\ttfamily Decoder\+::$\sim$\+Decoder (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [default]}}
...
{\footnotesize\ttfamily \mbox{\hyperlink{namespaceav_abcf8febb01b83a6bf7671fc1793f23f0}{av\+::\+Frame\+UPtr}} Decoder\+::get\+Frame (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{00044                               \{}
\DoxyCodeLine{00045     \textcolor{keywordflow}{if} (!codec\_ctx\_) throwRuntimeError(\textcolor{stringliteral}{"{}decoder was not initialized yet"{}});}
\DoxyCodeLine{00046 }
\DoxyCodeLine{00047     \textcolor{keywordflow}{if} (!frame\_) \{}
\DoxyCodeLine{00048         frame\_ = \mbox{\hyperlink{namespaceav_abcf8febb01b83a6bf7671fc1793f23f0}{av::FrameUPtr}}(av\_frame\_alloc());}
\DoxyCodeLine{00049         \textcolor{keywordflow}{if} (!frame\_) throwRuntimeError(\textcolor{stringliteral}{"{}failed to allocate frame"{}});}
\DoxyCodeLine{00050     \}}
\DoxyCodeLine{00051 }
...
\DoxyCodeLine{00054     \textcolor{keywordflow}{if} (ret < 0) throwRuntimeError(\textcolor{stringliteral}{"{}failed to receive frame from decoder"{}});}
\DoxyCodeLine{00055 }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{00030                                          \{}
\DoxyCodeLine{00031     \mbox{\hyperlink{classDecoder_a3afcf16131999c2fdeddb7d1d483a69d}{swap}}(*\textcolor{keyword}{this}, other);}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{00035                                                \{}
\DoxyCodeLine{00036     \textcolor{keywordflow}{if} (!codec\_ctx\_) throwRuntimeError(\textcolor{stringliteral}{"{}decoder was not initialized yet"{}});}
...
\DoxyCodeLine{00039     \textcolor{keywordflow}{if} (ret == AVERROR\_EOF) throwRuntimeError(\textcolor{stringliteral}{"{}has already been flushed"{}});}
\DoxyCodeLine{00040     \textcolor{keywordflow}{if} (ret < 0) throwRuntimeError(\textcolor{stringliteral}{"{}failed to send packet to decoder"{}});}
...
\item 
src/process/\mbox{\hyperlink{decoder_8h}{decoder.\+h}}\item 
src/process/\mbox{\hyperlink{decoder_8cpp}{decoder.\+cpp}}\end{DoxyCompactItemize}

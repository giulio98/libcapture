...
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00008}00008 \textcolor{preprocessor}{\#include "{}common/common.h"{}}}
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00009}00009 \textcolor{preprocessor}{\#include "{}converter.h"{}}}
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00010}00010 \textcolor{preprocessor}{\#include "{}decoder.h"{}}}
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00011}00011 \textcolor{preprocessor}{\#include "{}encoder.h"{}}}
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00012}00012 \textcolor{preprocessor}{\#include "{}video\_parameters.h"{}}}
...
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00031}00031     \textcolor{keywordtype}{void} startProcessor(av::MediaType media\_type);}
...
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00035}00035     \textcolor{keywordtype}{void} processPacket(\textcolor{keyword}{const} AVPacket *packet, av::MediaType type);}
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00036}00036     \textcolor{keywordtype}{void} processConvertedFrame(\textcolor{keyword}{const} AVFrame *frame, av::MediaType type);}
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00037}00037     \textcolor{keywordtype}{void} flushPipeline(av::MediaType type);}
...
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00049}00049     \mbox{\hyperlink{classPipeline_a882528d2d5712d429f33329dbf97b0dd}{Pipeline}}(\textcolor{keyword}{const} \mbox{\hyperlink{classPipeline}{Pipeline}} \&) = \textcolor{keyword}{delete};}
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00050}00050 }
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00051}00051     \mbox{\hyperlink{classPipeline}{\string~Pipeline}}();}
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00052}00052 }
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00053}00053     \mbox{\hyperlink{classPipeline}{Pipeline}} \&operator=(\textcolor{keyword}{const} \mbox{\hyperlink{classPipeline}{Pipeline}} \&) = \textcolor{keyword}{delete};}
...
\DoxyCodeLine{\Hypertarget{pipeline_8h_source_l00081}00081     \textcolor{keywordtype}{void} \mbox{\hyperlink{classPipeline_ab28f046f571aad557913004be339748d}{feed}}(av::PacketUPtr packet, av::MediaType packet\_type);}

...
int ScreenRecorder::CaptureVideoFrames() {
    ...
    int frameFinished;  // when you decode a single packet, you still don't have information enough to have a frame
                        ...
                        // that represents a frame, then you have a picture! that's why frameFinished will let //you know
                        // you decoded enough to have a frame.
...
int ScreenRecorder::init_outputfile() {
    ...
    /* Returns the output format in the list of registered output formats which best matches the provided parameters, or
    ...
    video_st->codecpar->codec_id =
        AV_CODEC_ID_MPEG4;  // AV_CODEC_ID_MPEG4; // AV_CODEC_ID_H264 // AV_CODEC_ID_MPEG1VIDEO
